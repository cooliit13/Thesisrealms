...
BukSU COT: Capstone Repository is a web-based system developed for the College of Technologies at Bukidnon State University. It serves as a centralized digital platform for uploading, browsing, and managing student capstone works. The system aims to streamline the research process by offering an accessible, organized, and secure environment where students, faculty, and administrators can collaborate and manage academic outputs efficiently.        </p>
    ...
    <div class="developer-card armando-card" style="animation-delay: 0.2s;">
        ...
        <p>Develops the server-side logic, databases, and application functionality behind the scenes.</p>
    ...
    <!-- Developer 2 -->
     <div class="developer-card kate-card" style="animation-delay: 0.2s;">
        ...
        <p>Designs the user interface and user experience, focusing on making the app or website visually appealing and easy to use.</p>
         <div class="social-links">
    ...
    <!-- Developer 3 -->
     <div class="developer-card janus-card" style="animation-delay: 0.2s;">
        ...
        <p>Builds the visual parts of a website or app that users interact with, using HTML, CSS, and JavaScript.</p>
         <div class="social-links">
